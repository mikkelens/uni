...
public class Inversions {
    ...
    public int countInversions(ArrayList<Integer> input) {
        ...
        int inversions = 0;
        for (int my_index = 1; my_index < input.size(); my_index++) {
            int me = input.get(my_index);
//            System.err.println(" - Me: " + me);
            for (int index_behind_me = my_index - 1; index_behind_me >= 0; index_behind_me--) {
                int behind_me = input.get(index_behind_me);
//                System.err.println("Behind me: " + behind_me);
                if (behind_me > me) {
                    inversions += 1;
//                    System.err.println("INVERSION: " + behind_me + " -> " + me);
                }
            }
        }
        return inversions;
